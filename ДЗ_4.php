...
<?php
$name = 'Юлия'; // строка
$city = 'Мурманск, Россия'; // строка
$profi = 'Оператор печати'; // строка
$email = 'yulya.purgina@list.ru'; // строка
$phone = 89095606672; // десятичное число
$age = 2022-1990;
$days = (2022-1990)*365;

$skills = [
        'skill_name' => ['Выпечка', 'Рекламное производство', 'QA', 'Английский язык'],
        'level' => [65, 70, 40, 65]
    ]
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Начальник цеха широкоформатной и интерьерной печати</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Aug 2008 - <span class="w3-tag w3-teal w3-round">Dec 2010</span></h6>
          <p>Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Печатник-полиграфист</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Jan 2011 - Jun 2011</h6>
          <p>Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Оператор широкоформатной печти и 3D печати / fasadi.ru</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Sep 2019 - Current</h6>
